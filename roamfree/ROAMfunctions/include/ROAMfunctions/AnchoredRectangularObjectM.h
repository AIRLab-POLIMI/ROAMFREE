...
/*
 * AnchoredRectangularObjectM.h
 *
 *  Created on: Jan 08, 2015
 *      Author: davide
 */

#ifndef ANCHOREDRECTANGULAROBJECT_H_
#define ANCHOREDRECTANGULAROBJECT_H_

#include <Eigen/Dense>

namespace ROAMfunctions {

class AnchoredRectangularObjectM {
...
public:
	...
	bool error(const Eigen::VectorXd &x, double **params,
		...
		Eigen::Map<Eigen::Vector3d> fohp(params[2]);
		Eigen::Map<Eigen::Vector4d> foq(params[3]);

		Eigen::Map<Eigen::Matrix<double, 9, 1> > cm(params[4]);
...
# 	include "generated/AnchoredRectangularObject_Err.cppready"
	...
	bool errorJacobian(const Eigen::VectorXd &x, double **params,
		...
		{
#     		include "generated/AnchoredRectangularObject_JErrQ.cppready"
			return true;
			break;
		}
		...
		{
#   		include "generated/AnchoredRectangularObject_JErrPose.cppready"
			return true;
			break;
		}
		...
		{
#  			include "generated/AnchoredRectangularObject_JErrDim.cppready"
			return true;
			break;
		}
		case 2: // jacobian wrt anchor frame
		{
#  			include "generated/AnchoredRectangularObject_JErrF.cppready"
			return true;
			break;
		}

		case 3: // jacobian wrt homogeneous point
		{
# 		 	include "generated/AnchoredRectangularObject_JErrFOhp.cppready"
			return true;
			break;
		}
		case 4: // jacobian wrt object orientation wrt anchor frame
		{
#  			include "generated/AnchoredRectangularObject_JErrFOq.cppready"
			return true;
			break;
		}
...
#endif /* ANCHOREDRECTANGULAROBJECT_H_ */
