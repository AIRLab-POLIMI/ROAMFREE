...
namespace g2o{
  ...
  int SparseOptimizer::optimize(int iterations, bool online)
  {
    ...
    // call the afterVertexUpdate() method on every active edge
    updateEdgeTemporaries();
  ...
  void SparseOptimizer::updateEdgeTemporaries() {
#   ifdef G2O_OPENMP
...
#   endif
  ...
  bool *SparseOptimizer::forceStopFlag()
  {
