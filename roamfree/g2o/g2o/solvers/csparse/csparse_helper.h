...
// the same as cs_cholsolsymb but B is a matrix
// VERY IMPORTAT, B must be COLUMN-MAJOR

int cs_cholsolsymb_matrixB(const cs *A, double *B, int Bn, const css* S, double* workspace, int* work);
